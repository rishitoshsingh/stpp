...
# def parse_single_scenario(serialized_scenario):
...
def process_single_tfrecord(file_path, split, DATAOUT, map_version):
    try:
...
def main(data_root, data_out, map_version="0.1", num_workers=os.cpu_count()):
...
if __name__ == "__main__":
    ...
    main(args.data_root, args.data_out, num_workers=args.num_workers)